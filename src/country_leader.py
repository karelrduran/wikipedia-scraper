...
class CountryLeaders:
    ...
    def refresh_cookies(self):
        try:
            self.cookies_data = requests.get(url=f"{self.root_url}{self.cookie_endpoint}").cookies
    ...
    def check_status(self):
        ...
        try:
            ...
            response = requests.get(f"{self.root_url}{self.status_endpoint}")
    ...
    def get_countries(self) -> List:
        ...
        if self.check_status():
            ...
            try:
                ...
                response = requests.get(url=f"{self.root_url}{self.countries_endpoint}", cookies=self.cookies_data)
    ...
    def get_leaders(self):
        ...
        if self.check_status():
            ...
            for country in self.countries_data:
                attempt = 1
                try:
                    response = requests.get(url=f"{self.root_url}{self.leaders_endpoint}", cookies=self.cookies_data,
